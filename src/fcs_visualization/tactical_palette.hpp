...
constexpr ::foxglove::schemas::Color MEASUREMENT_CONFIDENCE = {0.62, 0.66, 0.72, 0.48}; // 测量结果
...
// ============================================================================
namespace L3 {
constexpr ::foxglove::schemas::Color TRACKING_LOCKED    = with_alpha(Semantic::STATUS_ACTIVE, 0.92);   // 跟踪锁定
constexpr ::foxglove::schemas::Color TRACKING_ACQUIRING = with_alpha(Semantic::STATUS_ACTIVE, 0.58);   // 正在捕获目标
constexpr ::foxglove::schemas::Color TRACKING_WARNING   = with_alpha(Semantic::ALERT, 0.62);          // 跟踪告警
constexpr ::foxglove::schemas::Color TRACKING_LOST = with_alpha(Semantic::DECISION_NEGATIVE, 0.48);   // 目标丢失
...
constexpr ::foxglove::schemas::Color FIRE_READY    = with_alpha(Semantic::DECISION_POSITIVE, 0.84); // 开火就绪
constexpr ::foxglove::schemas::Color FIRE_COOLDOWN = with_alpha(Semantic::ALERT, 0.66);             // 冷却中
constexpr ::foxglove::schemas::Color FIRE_ABORTED  = with_alpha(Semantic::DECISION_NEGATIVE, 0.72); // 开火被中止
} // namespace L5

// 速度矢量箭头可视化
namespace Velocity {
constexpr ::foxglove::schemas::Color LINEAR  = with_alpha(Semantic::STATUS_ACTIVE, 0.78);  // 线速度
constexpr ::foxglove::schemas::Color ANGULAR = with_alpha(Semantic::ALERT, 0.72);         // 角速度
...
constexpr bool BILLBOARD_ENABLED = true; // 文本始终面向相机（Billboard）
} // namespace Text
...
// 时间相关可视化参数
namespace Temporal {
constexpr uint64_t ENTITY_LIFETIME_NS  = 100'000'000ULL; // Marker存活时间，纳秒 100ms
